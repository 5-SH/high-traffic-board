...
import traffic.board.articleread.service.response.ArticleReadPageResponse;
...
public class ArticleReadApiTest {
    ...
    void readAllInfiniteScrollTest() {
        List<ArticleReadResponse> responses1 = articleReadRestClient.get()
                .uri("/v1/articles/infinite-scroll?boardId=%s&pageSize=%s".formatted(1L, 5L, 150414925922836480L))
                .retrieve()
