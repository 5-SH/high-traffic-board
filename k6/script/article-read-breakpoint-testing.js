...
export default function () {
    ...
    const articleListResponse = http.get(`http://localhost:9005/v1/articles?boardId=1&pageSize=10&page=${randomPage}`);
    ...
    const articleResponse = http.get(`http://localhost:9005/v1/articles/${randomId}`);
